...
data class DTransaction constructor(
    ...
    @Parcelize
    data class PaymentInfo constructor(
    ...
    @Parcelize
    data class BonusInfo constructor(
        val business: String?
        , val storeName: String?
    ) : Parcelable

    @Parcelize
    data class RewardInfo constructor(
        val rewardRatio: Double?
    ) : Parcelable

    @Parcelize
    data class WithdrawInfo constructor(
        val bankName: String?
        , val bankAccount: String?
    ) : Parcelable

    @Parcelize
    data class OrderInfo constructor(
    ...
    enum class Status { ACTIVATED, REMOVED }
}