...
class InfoVerticalView : LinearLayout{
    var title:String? = ""
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        if (ta != null) {
            ...
            titleSize = ta.getDimensionPixelSize(R.styleable.InfoVerticalView_titleSize, resources.getDimensionPixelSize(R.dimen.f_normal))
            ...
            messageSize = ta.getDimensionPixelSize(R.styleable.InfoVerticalView_messageSize, resources.getDimensionPixelSize(R.dimen.f_normal))
            messageColor = ta.getColor(R.styleable.InfoVerticalView_messageColor, ContextCompat.getColor(context, R.color.colorTextBrand))
        }
    ...
    fun initView(context: Context){
        ...
        messageView!!.setPadding(0, ViewTool.getPixel(context, 10f), 0,0)
